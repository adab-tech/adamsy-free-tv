"""
Virtual TV Viewer GUI module - Classic (Tkinter/VLC) edition.

Streams free-to-air HLS/MPEG-TS channels using python-vlc.
Requires VLC media player installed and python-vlc package.

This is the original desktop UI, kept as an independent, fully
functional alternative alongside the default pywebview-based app in
app/tv_gui.py. Launch it via `tv_main.py --classic` or the "Adamsy
Free TV (Classic)" shortcut.
"""
